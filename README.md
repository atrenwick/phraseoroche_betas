...
# note : prefer this <LINK SHOULD APPEAR HERE> updated v2 script, which: 1) takes the XML directly from LGeRM, 2) conserves LGeRM's annotations, 3) calls Stanza much more tidily, 4) makes etrees much more tidily
